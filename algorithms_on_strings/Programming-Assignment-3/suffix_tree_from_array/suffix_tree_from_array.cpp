...
typedef map<size_t, vector<Edge>> SuffixTree;

void BreakEdge(const string& text, const SuffixTree &tree,
               size_t node, size_t pos, size_t offset)
{
...
int main() {
    ...
    // Build the suffix tree and get a mapping from suffix tree node ID
